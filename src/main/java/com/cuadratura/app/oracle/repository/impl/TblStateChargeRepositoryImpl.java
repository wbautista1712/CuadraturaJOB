...
public class TblStateChargeRepositoryImpl implements TblStateChargeRepositoryCustom {
	...
	public List<TblStateChargeDto> getFindAllTblStateCharge() {
		...
		String sql = "	SELECT  /*+ ALL_ROWS */  DISTINCT id_state_charge,		" + "	                load_table,		"
				+ "	                state_charge,		" + "	                state_send,		"
				+ "	                init_count_source,		" + "	                init_sum_source,		"
				+ "	                end_count_target,		" + "	                end_count_source,		"
				+ "	                end_sum_target,		" + "	                error_des,		"
				+ "	                load_date,		" + "	                init_load,		"
				+ "	                end_load,		" + "	                y.org_lvl_child		"
				+ "	  FROM cuadraturawyp.tbl_state_charge x,		"
